...
$.template('lsLayerManager',
    ...
    '<div class="ls-layermanager-content"></div>'+
    '</div>');
...
$.template('lsLayerManagerToolbar',
    '<div class="ls-layermanager-toolbar panel-body btn-toolbar"></div>');

$.template('lsLayerManagerElement',
    '<div class="ls-layermanager-element panel panel-info" id="ls-layermanager-element-${id}">'+
    '<div class="ls-layermanager-element-header panel-heading">'+
    '<div class="ls-layermanager-label panel-title">${label}'+
    ...
    '<div class="ls-layermanager-element-content panel-body">'+
        '<div class="ls-layermanager-element-visibility input-group">'+
